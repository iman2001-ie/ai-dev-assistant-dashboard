...
public class ChatController {
    ...
    public List<ChatMessageResponse> history(
            @RequestParam(required = false) Long errorLogId,
            @RequestParam(defaultValue = "false") boolean noContext
    ) {
        return chatService.history(errorLogId, noContext);
    }
    ...
    public void clearHistory(
        ...
        chatService.clearHistory(errorLogId, noContext);
    }
}
